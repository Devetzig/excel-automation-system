...
- **Product Catalog:** Integrates images, descriptions, pricing, and stock levels for easy reference.
- **Automation:** Advanced Excel formulas (VLOOKUP, INDEX-MATCH, SUMIF) and VBA macros reduce repetitive tasks by ~50%.
...
- LinkedIn: [in/devetzig](https://www.linkedin.com/in/devetzig)  
- GitHub: [devetzig](https://github.com/devetzig)
